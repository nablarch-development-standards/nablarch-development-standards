...
- UI標準(画面)を修正しました。
  - Nablarch6系がJakartaEE10前提となったことを踏まえ、「1.3. 本書におけるJakartaEE仕様への読み替えについて」を追加しました。
  - JSPについての説明を、Jakarta Server Pagesへの説明に修正しました。
- UI標準(画面)別冊_UI部品カタログを修正しました。
  - Nablarch6系がJakartaEE10前提となったことを踏まえ、「1.3. 本書におけるJakartaEE仕様への読み替えについて」を追加しました。
- 単体テスト標準を修正しました。
  - 転用を考慮して不要な変更履歴を削除しました。
- Nablarch開発標準設計書一覧を修正しました。
  - Nablarch6系がJakartaEE10前提となったことを踏まえ、「1.2. 本書におけるJakartaEE仕様への読み替えについて」を追加しました。
...
*1: 外部インターフェース設計書から汎用データフォーマットのフォーマット定義ファイル(fmt)を自動生成するツール。[開発プロセス支援ツール]( https://github.com/nablarch-development-standards/nablarch-development-standards-tools/tree/main/%E5%A4%96%E9%83%A8%E3%82%A4%E3%83%B3%E3%82%BF%E3%83%95%E3%82%A7%E3%83%BC%E3%82%B9%E8%A8%AD%E8%A8%88%E9%96%A2%E9%80%A3 )として公開されている。
